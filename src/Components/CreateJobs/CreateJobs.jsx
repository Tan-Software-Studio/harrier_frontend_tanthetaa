...
const CreateJobs = () => {
  ...
  const [salaryRangeSymbol, setSalaryRangeSymbol] = useState({
    id: "",
    currency_code: "",
  });
  ...
  const officeLocationSelectedID =
    officeLocationSelected && officeLocationSelected.map((d, i) => d.id);

  const [workScheduleOptions, setWorkScheduleOptions] = useState([]);
  const [workScheduleSelected, setWorkScheduleSelected] = useState([]);
  const workScheduleSelectedID =
    workScheduleSelected && workScheduleSelected.map((d, i) => d.id);
  ...
  const getOfficeLocationOptions = async () => {
    ...
    await axiosInstanceAuth
      .get("/v1/emp/emp_office_locations/index", formData)
      .then((res) => {
  ...
  const getWorkScheduleOptions = async () => {
    ...
    await axiosInstanceAuth
      .get("/v1/emp/emp_working_schedules/index", formData)
      .then((res) => {
                      ...
                      <Box component="form" noValidate autoComplete="off">
                        <FormControl variant="standard">
                          <InputLabel shrink htmlFor="experience">
                            What are the duties required in this role?
                    ...
                    <div className="w-100 mt-20">
                      <FormControl variant="standard">
                        ...
                        <div className="row align-items-center">
                          ...
                          <div className="mw-6 px-0 text-center">To</div>
                    ...
                    <div className="w-100 mt-20">
                      ...
                      >
                        <InputLabel shrink htmlFor="" className="">
                          Upload File (e.g. Job Specification, Employee
