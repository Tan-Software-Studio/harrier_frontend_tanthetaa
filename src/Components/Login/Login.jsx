      ...
      <div className={`${styles["login-page"]}`}>
        <div className="common-bg login-bg">
          <div className="container">
            ...
            <div className="bg-white mt-30">
              <div className="inside-box">
                ...
                <FormControl>
                  ...
                  >
                    ...
                    <Link
                      to=""
                      variant="solid"
                      className="text-end forgot-pwd my-2"
                      onClick={forgetOpen}
                    >
                      {" "}
                      Forgot Password?{" "}
                ...
                {fields.guest && (
                  <Link to="">
                    {" "}
                    <h4 className="common-title mt-4" onClick={handleOpen}>
            ...
            <Modal open={forget} onClose={forgetClose}>
              <Box sx={style}>
                <div className="text-end">
                  <button
                    className="bg-transparent border-0 text-right"
                  ...
                  <Box sx={style}>
                    ...
                    <div className="inside-modal">
                      ...
                      <Typography className="modal-modal-description mt-17">
                        <p>
                          Thank you for Request Guest Access to Harrier
                          Candidates..
                        </p>
                      </Typography>
                      <Typography className="modal-modal-description mt-17">
                        <p>
                          You will be contacted if an Guest Access requests to
                          see your anonymised CV.{" "}
                        </p>
                      </Typography>
                      <Typography className="modal-modal-description mt-17">
                        <p>
                          In the meantime, if you would like to browse the
                          Harrier Candidates database for salary benchmarking,
                      ...
                      <div className="text-center mt-40">
                        <Link to="/">
                          {" "}
                          <button className="commom-blue-button">Ok</button>
                        </Link>
                      </div>
                    </div>
                  </Box>
