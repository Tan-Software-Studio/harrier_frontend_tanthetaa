                ...
                <div className='container'>
                    <div className='main-tabs'>
                        ...
                        <p className='disclaimer'>
                            Shortlisting is for candidates who are of intrest, but you don't have a vacancy for them right now. When candidates data is upadated (for instance, if they go from being Very Passive to Active ) this will prompt a notifications so that you can approach this this talent before your competitors.
                        </p>
