...
import { Box, Button, FormControl, FormControlLabel, InputBase, InputLabel, TextField } from '@mui/material'
...
const Updatepassword = () => {
    ...
    const handelUpdatePassword = async () => {
        if (role == "emp") {
            ...
            await axiosInstance
                .post("v1/emp/new/password/update",
                    formData,
                )
                .then((res) => {
            ...
            await axiosInstance
                .post("v1/guest/new/password/update",
                    formData,
                )
                .then((res) => {
                    const msg = Decrypt(res?.data?.message).replace(/"/g, " ");
                        ...
                        <div className='inside-box'>
                            <form action="">
                                ...
                                <Box className="mt-50 text-center bg-transparent shadow-none">
                                    <Button variant="solid" className="common-btn ms-2" onClick={handelUpdatePassword}> Update password </Button>
                                </Box>
                            </form>
                        </div>
                    </div>
