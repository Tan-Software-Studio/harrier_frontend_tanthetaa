...
// ====== Material ui =====
import { Button, Checkbox, FormControl, InputBase, InputLabel, TextField } from '@mui/material'
                    ...
                    <div className='container'>
                        ...
                        <div className='signup-box mt-20'>
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-6">
                                    <FormControl variant="standard" className='mt-20 position-relative'>
                                        ...
                                        <TextField name="logo" value="" type="file" className="inputFile" id="file_upload" onChange={handleLogoChange}></TextField>
                                        <div className='d-flex justify-content-between'>
                                            {uploadicon?.name}
                                            {uploadicon?.name && <button className='bg-transparent border-0 text-right' onClick={() => setUploadIcon({})}> <img src={roundcloseIcon} alt="" /> </button>
                                            }
                                        </div>
                                ...
                                <div className="col-lg-6">
                                    <FormControl variant="standard" className='mt-20'>
                                        ...
                                        <TextField name="url" value={inputData.url} onChange={onchangeinput} placeholder="ex. www.harrier.com"></TextField>
                                    </FormControl>
                                </div>

                                <div className='checkBox d-flex align-items-start mt-3 '>
                                    <Checkbox className='ps-0' onChange={serviceCheck} checked={terms ? true : false} onClick={(e) => setTandc(!tandc)} />
                                    {/* <p className='content'> By signing-up you agree to
                                        <a target="blank" href='/termsofuse'> our Terms of Use </a>
                                    </p> */}

                                    <p className='content'> Our <a target="_blank" href='/termsofuse'> Terms of Use</a> govern your access to and use of Harrier Candidates – please read them carefully before you use this service. By using Harrier Candidates, or by clicking this tick box, you accept and agree to be bound and abide by these Terms of Use. If you do not want to agree to these Terms of Use, you must not access or use Harrier Candidates.
                                ...
                                <div className='checkBox d-flex align-items-start mt-3 '>
                                    ...
                                    <p className='content'> Please review our commercial terms. If you are happy to proceed then on Sign Up we will then send our <a target="blank" href='/termsofbusiness'>  Commercial Terms  </a> to the Point of Contact for Invoices via DocuSign. Once terms are signed, you will be provided with login credentials.
                                ...
                                <Box className="mt-50 text-center bg-transparent shadow-none">
                                    <Button onClick={handleSubmit} variant="solid" className='common-btn' disabled={terms === true ? "" : true}>Sign Up</Button>
                                </Box>
                                            ...
                                            <div className="modal-size">
                                                <Box sx={style}>
                                                    ...
                                                    <div className='inside-modal'>
                                                        ...
                                                        <Typography className="modal-modal-description mt-17"><p>HVR WILL COME BACK TO THIS
                                                        </p>
                                                        ...
                                                        <div className='text-center mt-40'>
                                                            <Link to="/login/emp"> <button className="commom-blue-button">Ok</button></Link>
                                                        </div>
                                                    </div>
                                                </Box>
                                            </div>
