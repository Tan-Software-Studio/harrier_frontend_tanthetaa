                      ...
                      >
                        <Box sx={style}>
                          ...
                          <Typography id="success-modal">
                            ...
                            <h6 className="pt-2">
                              You will be contacted by our Candidate Success
                              team if an employer requests to see your
                              anonymised CV regarding a specific vacancy. N.B.:
                              Employer Users will not be able to see the
                              profiles of their own Employees within the
                              database, safeguarding your privacy.
                            </h6>
                            <h6 className="pt-2">
