            ...
            <div className={`${styles['candidate-details']}`}>
                <div className='common-bg'>
                    <div className="container">
                        <button className='bg-transparent border-0 back-button d-flex align-items-center' onClick={() => navigate("/candidates")}> <img src={backButton} alt="" /> <span> Back </span> </button>
                                ...
                                <div className="candidate-bg">
                                    ...
                                    <div className='px-30 mt-30'>
                                        ...
                                        <div className="row mt-30 align-items-center">
                                            ...
                                            <div className="col-lg-8">
                                                <div className='answers'>
                                                    <div className="answer-bg">{String(candidate?.desired_country)}</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="row mt-30 align-items-center">
                                            ...
                                            <div className="col-lg-8">
                                                <div className='answers'>
                                                    <div className="answer-bg">{String(candidate?.desired_region)}</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="row mt-30 align-items-center">
                                            ...
                                            <div className="col-lg-8">
                                                <p className='answers'>{candidate?.desired_salary_symbol} {String(candidate?.desired_salary)}</p>
                                            </div>
                                        </div>
                                        <div className="row mt-30 align-items-center">
                                            <div className="col-lg-4">
                                            ...
                                            <div className="col-lg-8">
                                                <div className='answers'>
                                                    {candidate.status == 1 ?
                                                        ...
                                                        <div className='bg-Color-success'>
                                                            Active
                                                        </div>
                                                        : candidate.status == 2 ?
                                        ...
                                        <div className="row mt-30 align-items-center">
                                            ...
                                            <div className="col-lg-8">
                                                <p className='answers'>{candidate?.freelance_daily_rate_symbol} {candidate?.freelance_daily_rate}</p>
                                            </div>
                                        </div>
                                        <div className="row mt-30 align-items-center">
                                            <div className="col-lg-4">
                                            ...
                                            <div className="col-lg-8">
                                                <div className='answers'>
                                                    <div className="answer-bg">
                                                        {String(candidate?.desired_working_arrangements)}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row px-30 justify-content-between">
                                        <div className="col-lg-5">
                                            ...
                                            <div className="row mt-30 ">
                                                ...
                                                <div className="col-lg-7">
                                                    <p className='answers'>{candidate?.deal_size_symbol} {candidate?.deal_size}</p>
                                                </div>
                                            </div>
                                            <div className="row mt-30 ">
                                                <div className="col-lg-5">
                                                ...
                                                <div className="col-lg-7">
                                                    <p className='answers'>{candidate?.sales_quota_symbol} {candidate?.sales_quota}</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-lg-5">
                                    ...
                                    <div className="row px-30 justify-content-between">
                                        ...
                                        <div className="col-lg-5">
                                            ...
                                            <div className="row mt-30 ">
                                                ...
                                                <div className="col-lg-7">
                                                    <div className='answers'>
                                                        <div className="answer-bg">{String(candidate?.languages)} </div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
