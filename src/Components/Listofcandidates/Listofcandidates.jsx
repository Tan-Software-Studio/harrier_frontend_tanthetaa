...
import { Box, Chip, Dialog, DialogActions, DialogContent, DialogContentText, FormControl, InputLabel, Radio, RadioGroup, TextField, Typography } from '@mui/material';
    ...
    const quickTypeSearch = (e) => {
        ...
        if (e.target.value) {
            const searchData = oldCandidatesListDetails.filter((i) => {
                ...
                let time_in_industry_diff = i?.time_in_industry_diff?.toLowerCase().includes(e.target.value.toLowerCase())
                                                        ...
                                                        <TableBody>
                                                            {candidatesListDetails.map((d, index) => (
                                                                ...
                                                                >
                                                                    ...
                                                                    <TableCell align="right" onClick={(e) => handleEdit(d.uuid)}>{d.job_title}</TableCell>
                                                                    <TableCell align="right" onClick={(e) => handleEdit(d.uuid)}>{d.employer_type_list?.title}</TableCell>
                                                                    <TableCell align="right" onClick={(e) => handleEdit(d.uuid)}>
                                                                        {d.time_in_current_role_diff}
                                                                    </TableCell>
                                                                    <TableCell align="right" onClick={(e) => handleEdit(d.uuid)}>
                        ...
                        <DialogContent>
                            <DialogContentText >
                                <div className="job-update-wrapper">
                                    <div className="d-flex justify-content-end" onClick={handleClosePopUp}>
                                        <CloseIcon />
                                    </div>
                                    ...
                                    <div className="sub-title">
                                        Select Live Job for which you want to hire candidate
                                    </div>
                                    <div component="form" role="form" className="form-content new-mh-height">

                                        {jobNames.length > 0 && jobNames.map((d, i) => {
                                            return (
                                                <div className="radioBtn detail-content">
                                                    <label class="form-check-label" for="radio1">{d?.job_title}</label>
                                                    <input
                                                        type="radio"
                        ...
                        <div className="modal-size">
                            <Box sx={style}>
                                <div className='text-end' >
                                    <button className='bg-transparent border-0 text-right' onClick={handleCloseThankYouPopUp}> <img src={closeIcon} alt="" /> </button>
                                </div>
                                <div className='inside-modal'>
                                    <div className='text-center done-icon'>
                                        <img src={doneIcon} alt="" />
                                    </div>
                                    <Typography id="modal-modal-title" className="modal-modal-title mt-30" ><h1>Congratulations!</h1> </Typography>
                                    <Typography className="modal-modal-description mt-17">
                                        <p>
                                            You have successfully sent the Candidate a CV Request to candidate. You will be notified when the Candidate decides to accept or reject your CV Request.
                                        </p>
                                    </Typography>
                                    <div className='text-center mt-40'>
                                        <Link to="/live-jobs"> <button className="pop-up-submit-btn">Done</button></Link>
                                    </div>
                                </div>
                            </Box>
                        </div>
